...
if __name__ == '__main__':
    exc = Excel("result.xlsx")
    wb = exc.create_excel("result.xlsx", sheet_name="1")
    # wb = ws.create_sheet(wb, "31")
    # ws = wb.worksheets[0]
    ws = wb.worksheets[0]  # 第三个sheet页
    # ws.append(wb, [1, 2, 3, 4, 5, 6])
    exc.write_by_append(ws, ["123", "231"])
    exc.save_excel(wb)
